...
<section id="navbar" class="container-fluid mb-4">
    <nav>
        <div>
            <a><img src="{{ asset('website/img/logo-hoordad-nav.png') }}" style="max-width: 70px; max-height: 50px"></a>
            <input value="s">
...
<section id="category-1" class="container-fluid mb-4" style="background-color: #EFEFEF">
    <div class="container">
        asdfadf<br/>
        asdfadf<br/>
        asdfadf<br/>
...
<section id="newest-products" class="container mb-4">
    <div class="container">
...
<section id="category-2" class="container-fluid d-flex justify-content-center mb-4" style="background-color: #EFEFEF">
...
<section id="best-selling" class="container-fluid mb-4">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-2 mx-1" style="border: 1px solid; border-radius: 5px">
                <div class="row">
                    <img style="max-height: 230px; max-width: 230px;" src="{{ asset('website/img/products/best-selling/lamp-400-400.jpg') }}">
                </div>
                <p>لامپ 200 وات</p>
